...
{
    public static final Effect enderDistortion = new EnderDistortionEffect().setRegistryName(ConsumablesAndCharms.MOD_ID, "ender_distortion");
    
    @SubscribeEvent
    public static void registerEffects(RegistryEvent.Register<Effect> register)
    {
        register.getRegistry().register(enderDistortion);
    }
}
